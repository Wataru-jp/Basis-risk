...
graph export figure/yield-rain.eps, as(eps) name("Graph") replace
...
graph export figure/yield-rain2.eps, as(eps) name("Graph") replace
...
***** Table 3 _choma*****
esttab using table/yield-rain.tex, ///
...
***** Table 3 _malima*****
esttab using table/yield-rain_malima.tex, ///
	se label nogap nonotes nomtitles b(%4.3f) nostar ///
...
***** Table 3 *****
esttab reg1 reg2 reg3 reg4 reg5 reg6 using table/table3-yield-rain_both.tex, ///
